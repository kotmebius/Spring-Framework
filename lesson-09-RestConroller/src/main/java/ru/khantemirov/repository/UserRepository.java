...
public interface UserRepository extends JpaRepository<User, Long>{
    ...
    @Query(value = "select * from users u where (:usernameFilter is null or u.username like :usernameFilter) " +
            "and (:emailFilter is null or u.email like :emailFilter) ",
            countQuery = "select count(*) from users u where (:usernameFilter is null or u.username like :usernameFilter)" +
                    "and (:emailFilter is null or u.email like :emailFilter)",
            nativeQuery = true)
